...
Two middleware functions are provided by default in the `clojure-luminus-spike.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `clojure-luminus-spike.handler` namespace to manage the enabled middleware.
